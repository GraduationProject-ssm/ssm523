...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=121)


# 第1章 绪论
## 1.1选题动因
当前的网络技术，软件技术等都具备成熟的理论基础，市场上也出现各种技术开发的软件，这些软件都被用于各个领域，包括生活和工作的领域。随着电脑和笔记本的广泛运用，以及各种计算机硬件的完善和升级，市面上的电脑和笔记本的性能都得到提升，可以支持的软件也逐渐增多，因此，在计算机上安装软件来发挥其高效地信息处理的作用，则很受人们的青睐。对于公交信息来讲，通过手工形式处理，在面对庞大的信息数量时，就显得不适宜了，首先需要花费的时间比较多，其次数据出错率比较高，而且对错误的数据进行更改也比较困难，最后，检索数据费事费力。因此，为了解决上述问题，有必要建立健身房预约系统，来规范公交信息管理流程，让管理工作可以系统化和程序化，同时，健身房预约系统的有效运用可以帮助管理人员准确快速地处理信息。
## 1.2目的和意义
健身房预约系统可以对公交信息进行集中管理，可以真正避免传统管理的缺陷。健身房预约系统是一款运用软件开发技术设计实现的应用系统，在信息处理上可以达到快速的目的，不管是针对数据添加，数据维护和统计，以及数据查询等处理要求，健身房预约系统都可以轻松应对。所以，健身房预约系统的运用是让公交信息管理升级的最好方式。它可以实现信息处理的便利化要求，还可以规范信息处理的流程，让事务处理成为管理人员手中的一件简单事，而不是之前手工处理时的困难事。尽管健身房预约系统具备较完善的功能，但是也需要管理人员利用闲暇时间提升自身素质以及个人能力，在操作健身房预约系统时可以最大化运用健身房预约系统提供的功能，让系统在满足高效率处理数据的同时，也能始终稳定运行，还可以确保数据的可靠性与数据处理的质量。
## 1.3论文结构安排
...
# 第2章 开发环境与技术
开发健身房预约系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
### 3.1.1操作可行性分析
开发本系统需要用到的工具，本人都比较熟悉，因此可以使用这些工具，完整开发健身房预约系统。此外，健身房预约系统在功能上，基本都是完成信息的处理，涵盖了添加，修改，删除等，而且操作者面对的都是各个功能操作界面，并不是编码后台，所以一般的使用者都可以通过操作界面轻松完成信息的加工处理。因此，本系统操作可行。
### 3.1.2经济可行性分析
...
### 3.1.3技术可行性分析
本系统需要的软件包括Eclipse，Tomcat，Mysql等，这些工具都接触并使用过，至于JAVA，B/S，vue，Html等技术，图书馆都有对应的书籍可以参考学习，加上平时课堂上学习的编程小项目对这些技术都有讲解，另外，本人也从课程设计作业中锻炼了编程能力。所以在技术上，可以完成健身房预约系统的编程开发。

通过上面的分析，已经确定了本系统在经济上的可行，本系统在技术上的可行，本系统在操作上的可行。由此，可以得出在目前的条件下，对于健身房预约系统的设计与实现是可以进行下去的。
## 3.2系统流程分析
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析健身房预约系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
（1）下图是私教课程预约实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\私教课程预约.jpg](/md/blog.005.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\私教课程预约.jpg")
图4.1 私教课程预约实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\用户.jpg](/md/blog.006.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\用户.jpg")
图4.2 用户实体属性图

（3）下图是字典表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\字典表.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\字典表.jpg")
图4.3 字典表实体属性图

（4）下图是教练实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\教练.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\教练.jpg")
图4.4 教练实体属性图

（5）下图是自助健身预约实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\自助健身预约.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\自助健身预约.jpg")
图4.5 自助健身预约实体属性图

（6）下图是留言版实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\留言版.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\留言版.jpg")
图4.6 留言版实体属性图

（7）下图是自助健身实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\自助健身.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\自助健身.jpg")
图4.7 自助健身实体属性图

（8）下图是公告实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\公告.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\公告.jpg")
图4.8 公告实体属性图

（9）下图是器械班实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\器械班.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\器械班.jpg")
图4.9 器械班实体属性图

（10）下图是堂课实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\堂课.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\堂课.jpg")
图4.10 堂课实体属性图

（11）下图是堂课预约实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\堂课预约.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\堂课预约.jpg")
图4.11 堂课预约实体属性图

（12）下图是器械班预约实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\器械班预约.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\器械班预约.jpg")
图4.12 器械班预约实体属性图

（13）下图是用户表实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\jainshenfangyuyue\用户表.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\jainshenfangyuyue\用户表.jpg")
图4.13 用户表实体属性图
...
|5|jiaolian\_shanchangxiangmnu|String|擅长项目|是|
|6|jiaolian\_suodejiangxiang|String|所得奖项|是|
|7|jiaolian\_email|String|邮箱|是|
|8|jiaolian\_delete|Integer|假删|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|ketang\_name|String|堂课名称|是|
|3|ketang\_types|Integer|堂课类型|是|
|4|ketang\_photo|String|堂课图片|是|
|5|ketang\_content|String|堂课详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|ketang\_id|Integer|课程|是|
|3|yonghu\_id|Integer|用户|是|
|4|ketangyuyue\_yesno\_types|Integer|预约审核|是|
|5|ketangyuyue\_yesno\_text|String|审核原因|是|
|6|create\_time|Date|创建时间|是|
表4.5留言版表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|qixieban\_name|String|器械班名称|是|
|3|qixieban\_types|Integer|器械班类型|是|
|4|qixieban\_photo|String|器械班图片|是|
|5|qixieban\_content|String|器械班详情|是|
|6|create\_time|Date|创建时间|是|
表4.8器械班预约表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|qixieban\_id|Integer|器械班|是|
|3|yonghu\_id|Integer|用户|是|
|4|qixiebanyuyue\_yesno\_types|Integer|预约审核|是|
|5|qixiebanyuyue\_yesno\_text|String|审核原因|是|
|6|create\_time|Date|创建时间|是|
表4.9私教课程预约表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|sijiao\_name|String|课程名称|是|
|3|sijiao\_types|Integer|课程类型|是|
|4|jiaolian\_id|Integer|教练|是|
|5|sijiao\_photo|String|课程图片|是|
|6|sijiao\_jiage|String|课程价格|是|
|7|sijiao\_content|String|私教课程详情|是|
|8|create\_time|Date|创建时间|是|
表4.10私教课程预约表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|sijiao\_id|Integer|课程|是|
|3|yonghu\_id|Integer|用户|是|
|4|sijiaoyuyue\_yesno\_types|Integer|预约审核|是|
|5|sijiaoyuyue\_yesno\_text|String|审核原因|是|
|6|create\_time|Date|创建时间|是|
表4.11用户表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zizhujianshen\_name|String|自助健身名称|是|
|3|zizhujianshen\_types|Integer|自助健身类型|是|
|4|zizhujianshen\_photo|String|自助健身图片|是|
|5|zizhujianshen\_number|Integer|可预约人数|是|
|6|zizhujianshen\_time|Date|可预约时间|是|
|7|zizhujianshen\_content|String|自助健身详情|是|
|8|create\_time|Date|创建时间|是|
表4.13自助健身预约表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zizhujianshen\_id|Integer|自助健身|是|
|3|yonghu\_id|Integer|用户|是|
...
图5.1 用户信息管理页面
### 5.2 课堂信息管理
如图5.2显示的就是课堂信息管理页面，此页面提供给管理员的功能有：查看已发布的课堂信息数据，修改课堂信息，课堂信息作废，即可删除，还进行了对课堂信息名称的模糊查询 课堂信息信息的类型查询等等一些条件。
...
图5.2 课堂信息管理页面
### 5.3私教课程管理
如图5.3显示的就是私教课程管理页面，此页面提供给管理员的功能有：根据私教课程进行条件查询，还可以对私教课程进行新增、修改、查询操作等等。
...
图5.3 私教课程管理页面
### 5.1自助健身管理
如图5.4显示的就是自助健身管理页面，此页面提供给管理员的功能有：根据自助健身进行新增、修改、查询操作等等。
